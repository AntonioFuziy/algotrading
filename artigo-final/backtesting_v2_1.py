...
class Strategy():
    ...
    def _receive(self, event):
        ...
        if event.type == Event.CANDLE:
            ...
            self._last[event.instrument] = [event.price,event.price,event.price,event.price]
        ...
        if not self._trade.zeroed() and event.instrument in self._last: # new price event and strategy has allocation
